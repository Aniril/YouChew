...
public bool  ChangePassword(string username, string oldPassword, string newPassword, Guid id)
{
...
public override bool  ValidateUser(string username, string password)
{
	...
	return this.uow.UserRepository.Get().Any(user => (user.username == username.Trim()) && (user.password == hash));
}
